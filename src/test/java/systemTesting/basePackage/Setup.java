    ...
    public synchronized void initZephyrReporter() {
        try {
            if (Constants.FLAG_UPDATE_ZEPHYR) {
                ...
                JiraGenericFunctions.setMongoZephyrTCDBDetails(LocalConfig.QA_MONGODB, ZEPHYR_TC_MAPPING_COLLECTION);
